...
export class Architect {
    ...
    async designArchitecture(context: ContextData): Promise<string> {
        try {
    ...
    async suggestPatterns(code: string, language: string, context: ContextData): Promise<string> {
        try {
    ...
    async analyzeScalability(code: string, language: string, context: ContextData): Promise<string> {
        try {
    ...
    async recommendStructure(context: ContextData): Promise<string> {
        try {
    ...
    private async generateArchitectureDesign(context: ContextData): Promise<string> {
...
Make it comprehensive and actionable.`;
    ...
    private async generatePatternSuggestions(code: string, language: string, context: ContextData): Promise<string> {
...
Be specific and provide practical examples.`;
    ...
    private async generateScalabilityAnalysis(code: string, language: string, context: ContextData): Promise<string> {
...
Provide actionable insights and specific recommendations.`;
    ...
    private async generateStructureRecommendations(context: ContextData): Promise<string> {
