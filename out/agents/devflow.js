...
exports.DevFlow = void 0;
class DevFlow {
    constructor(ai) {
        this.ai = ai;
    }
    async setupCI(context) {
        try {
    ...
    async setupInfrastructure(context) {
        try {
    ...
    async generateDeploymentScripts(context) {
        try {
    ...
    async generateCIConfiguration(context) {
...
Make it production-ready and follow Docker best practices.`;
    ...
    async generateInfrastructureCode(context) {
...
Choose the most appropriate infrastructure platform and provide complete configuration.`;
    ...
    async generateDeploymentConfiguration(context) {
...
exports.DevFlow = DevFlow;
//# sourceMappingURL=devflow.js.map