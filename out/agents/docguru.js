...
class DocGuru {
    ...
    async generateApiDocs(code, language, context) {
        try {
    ...
    async generateInlineComments(code, language, context) {
        try {
    ...
    async generateReadmeContent(context) {
...
Make it professional and comprehensive.`;
    ...
    async generateApiDocumentation(code, language, context) {
...
Format as proper API documentation.`;
    ...
    async generateCommentedCode(code, language, context) {
...
exports.DocGuru = DocGuru;
//# sourceMappingURL=docguru.js.map